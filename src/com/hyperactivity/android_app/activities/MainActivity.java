...
public class MainActivity extends FragmentActivity implements
		ForumEventCallback, AdminActionCallback {
	public static final int HOME_FRAGMENT = 0, FORUM_FRAGMENT = 1,
			DIARY_FRAGMENT = 2, CREATE_THREAD_FRAGMENT = 3,
			SEARCH_FRAGMENT = 4, VIEW_THREAD_FRAGMENT = 5,
			SETTINGS_FRAGMENT = 6, VIEW_PROFILE_FRAGMENT = 7,
			CHAT_FRAGMENT = 8;
